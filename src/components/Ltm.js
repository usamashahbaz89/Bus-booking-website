...
class ltm extends React.Component {
    state = {  } 
    render() { 
        return (
           <>
...
<button type="button" class="btn btn-primary" style={{backgroundColor:"#0071cc"}}>Modify Search </button>
             ...
             <div  className="container" style={{height:"250px", width:"200px", backgroundColor:"white", position:"relative", top:"40px", right:"470px", borderRadius:"15px"}}>
                 <h3>Filter</h3>
                 <div> 
           ...
           <div className="container" style={{height:"250px", width:"900px", backgroundColor:"white", position:"relative", bottom:"210px", left:"120px", borderRadius:"15px"}}>

               <div class="container">
                   <h3 style={{paddingLeft:"250px", paddingTop:"10px"}}>Lahore to Muzaffargarh</h3>
               </div>
               ...
               <img src='ltm faisal movers.png' style={{display:"inline"}}/>
