...
class lhrtopeshawar extends React.Component {
    state = {  } 
    render() { 
        return (
           <>
         ...
         <div style={{height:"600px", width:"1349px", backgroundColor:"#dee2e6"}}>
             ...
             <div className="container" style={{height:"150px", backgroundColor:"white", position:"relative", top:"30px", borderRadius:"15px"}}>
              <h3 style={{ paddingTop:"10px"}}>Lahore to Peshawar</h3> 
...
<button type="button" class="btn btn-primary" style={{backgroundColor:"#0071cc"}}>Modify Search </button>
             ...
             <div  className="container" style={{height:"262px", width:"200px", backgroundColor:"white", position:"relative", top:"40px", right:"470px", borderRadius:"15px"}}>
                 <h3>Filter</h3>
                 <div> 
           ...
           <div className="container" style={{height:"400px", width:"900px", backgroundColor:"white", position:"relative", bottom:"220px", left:"120px", borderRadius:"15px"}}>

               <div class="container">
                   <h3 style={{paddingLeft:"250px", paddingTop:"10px"}}>Lahore to Peshawar</h3>
               </div>
               ...
               <img src='lhrtopesh faisal movers.png' style={{display:"inline"}}/>
               ...
               <button type="button" class="btn btn-primary" style={{backgroundColor:"#023669", borderColor:"#023669", marginLeft:"70px"}}>View Timing </button>
                   ...
                   <div className="container" style={{ position:"relative", backgroundColor:"#f8f9fa", width:"870px", height:"130px", borderRadius:"10px", marginTop:"10px", boxShadow:"5px 5px 5px #888888"}}>
               <img src='lhrtopesh sania express.png' style={{display:"inline"}}/>
               <img src='ltm departuretime.png' style={{display:"inline"}}/>
               <img src='lhrtopesh class.png' style={{display:"inline", paddingLeft:"25px"}}/>
               <button type="button" class="btn btn-primary" style={{backgroundColor:"#023669", borderColor:"#023669", marginLeft:"80px"}}>View Timing </button>
                   </div>
               </div> 
