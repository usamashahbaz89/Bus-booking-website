...
class lhrtoisl extends React.Component {
    state = {  } 
    render() { 
        return (
           <>
...
<button type="button" class="btn btn-primary" style={{backgroundColor:"#0071cc"}}>Modify Search </button>
             ...
             <div  className="container" style={{height:"300px", width:"200px", backgroundColor:"white", position:"relative", top:"40px", right:"470px", borderRadius:"15px"}}>
                 ...
                 <div> 
                     ...
                     <p style={{fontSize:"13px"}}>Hazara Movers</p>
           ...
           <div className="container" style={{height:"550px", width:"900px", backgroundColor:"white", position:"relative", bottom:"258px", left:"120px", borderRadius:"15px"}}>

               <div class="container">
                   <h3 style={{paddingLeft:"250px", paddingTop:"10px"}}>Lahore to Islamabad</h3>
               </div>
               ...
               <img src='lhrtoisl sania express.png' style={{display:"inline"}}/>
               ...
               <button type="button" class="btn btn-primary" style={{backgroundColor:"#023669", borderColor:"#023669", marginLeft:"70px"}}>View Timing </button>
                   ...
                   <div className="container" style={{ position:"relative", backgroundColor:"#f8f9fa", width:"870px", height:"130px", borderRadius:"10px", marginTop:"10px", boxShadow:"5px 5px 5px #888888"}}>
               <img src='lhrtoisl faisal movers.png' style={{display:"inline"}}/>
               <img src='ltm departuretime.png' style={{display:"inline"}}/>
               <img src='ltm ex.png' style={{display:"inline"}}/>
               <button type="button" class="btn btn-primary" style={{backgroundColor:"#023669", borderColor:"#023669", marginLeft:"70px"}}>View Timing </button>
                   </div>
                   <div className="container" style={{ position:"relative", backgroundColor:"#f8f9fa", width:"870px", height:"130px", borderRadius:"10px", marginTop:"10px", boxShadow:"5px 5px 5px #888888"}}>
               <img src='lhrtoisl hazara.png' style={{display:"inline"}}/>
               <img src='ltm departuretime.png' style={{display:"inline"}}/>
               <img src='ltm ex.png' style={{display:"inline"}}/>
               <button type="button" class="btn btn-primary" style={{backgroundColor:"#023669", borderColor:"#023669", marginLeft:"70px"}}>View Timing </button>
                   </div>
